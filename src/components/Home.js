...
function Home() {
  ...
  const { api,setNotes, count, getAllNote, notes, setNote, deleteNoteController } =
    context;
                ...
                <Draggable key={_id} draggableId={_id} index={index}>
                  {(provided) => (
                    <li
                      ...
                      ref={provided.innerRef}
                      className="m-2 p-3 transition-colors ease-in-out mb-5 transition transition-transform hover:scale-105"
                      style={{
